<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="mb-2">
            ...
            <input id="birthday" type="date" class="form-control " name="birthday" value="{{ old('birthday', $user->birthday) }}" autocomplete="birthday" autofocus>
        </div>
            ...
            <div>
                <p class="text-sm mt-2 text-muted">
                    ...
                    <button form="send-verification" class="btn btn-outline-dark">
                        {{ __('Clicca per inviare di nuovo l\' Email di conferma.') }}
                    </button>
                </p>
